...
function onOpen() {
  ...
  machineConfiguration.setDescription("M744");
  machineConfiguration.setVendor("MATSUURA");
...
if (programName) {
  ...
  if (programComment) {
    writeln(/*"O" + oFormat.format(programId) + */"(" + filterText(String(programId).toUpperCase(), permittedCommentChars) + ")");
...
function onClose() {
  ...
  writeBlock(mFormat.format(16)); //stop chip flush
