...
function onOpen() {
  ...
  machineConfiguration.setDescription("M748");
  machineConfiguration.setVendor("KOMO");
...
function onCyclePoint(x, y, z) {
  ...
  if (isFirstCyclePoint()) {
    ...
    case "left-tapping":
      if (properties.useRigidTapping != "no") {
        writeBlock(mFormat.format(04), sOutput.format(tool.spindleRPM));
        writeBlock(mFormat.format(84), sOutput.format(tool.spindleRPM));
      }
      if (properties.usePitchForTapping) {
        writeBlock(
    ...
    case "circular-pocket-milling":
      ...
      writeBlock(gMotionModal.format(1), "Z" + xyzFormat.format(z));
      writeBlock(gFormat.format(13), 
        "I" + xyzFormat.format(tool.diameter/2), "K" + xyzFormat.format(cycle.diameter/2),
        "Q" + xyzFormat.format(cycle.stepover), dOutput.format(d), feedOutput.format(F), "C" + xyzFormat.format(cycle.repeatPass+2));
      break;  
    case "manual-boring":
      writeBlock(
