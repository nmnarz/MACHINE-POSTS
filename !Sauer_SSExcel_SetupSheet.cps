/**
  ...
  $Revision: 41892 e75136a4cb0f837e4fc89fbbf7a385ba601d5c68 $
  $Date: 2018-03-19 15:40:11 $
...
setCodePage("utf-8");
dependencies = "!Sauer_SSExcel_SetupSheet.xlsx";
...
properties = {
  ...
  jobNotes: "Fill Out Please",
  xyLocation: "LOWER LEFT CORNER",
  xLocationDim: 0,
  yLocationDim: 0,
  zLocation: "TOP OF STOCK",
};
...
propertyDefinitions = {
  ...
  xyLocation: {
    title: "XY LOCATION",
    description: "XY LOCATION RELATED TO STOCK",
    type: "enum",
    values:[
      {title:"AUTO-SET", id:"AUTO-SET"},
      {title:"AUTO-SET W/PROBE", id:"AUTO-SET W/PROBE"},
      {title:"LOWER LEFT CORNER", id:"LOWER LEFT CORNER"},
      {title:"LOWER RIGHT CORNER", id:"LOWER RIGHT CORNER"},
      {title:"LOWER MIDDLE", id:"LOWER MIDDLE"},
      {title:"UPPER LEFT CORNER", id:"UPPER LEFT CORNER"},
      {title:"UPPER RIGHT CORNER", id:"UPPER RIGHT CORNER"},
      {title:"UPPER MIDDLE", id:"UPPER MIDDLE"},
      {title:"CENTER OF STOCK", id:"CENTER OF STOCK"},
      {title:"CENTER OF PIN", id:"CENTER OF PIN"},
      {title:"CENTER OF HOLE INDICATED", id:"CENTER OF HOLE INDICATED"},
      {title:"POSITION INDICATED ON ILLISTRATION", id:"POSITION INDICATED ON ILLISTRATION"},
      {title:"X0. CENTER OF PALLET, Y0. BOTTOM OF STOCK", id:"X0. CENTER OF PALLET, Y0. BOTTOM OF STOCK"},
    ]
  },
  xLocationDim: {title:"X OFFSET", description:"X OFFSET DIMENSION", type:"number"},
  yLocationDim: {title:"Y OFFSET", description:"Y OFFSET DIMENSION", type:"number"},
  zLocation: {
    title: "Z LOCATION",
    description: "Z LOCATION RELATED TO STOCK",
    type: "enum",
    values:[
      {title:"TOP OF STOCK", id:"TOP OF STOCK"},
      {title:"TOP OF 44mm PARALLELS +", id:"TOP OF 44mm PARALLELS +"},
      {title:"TOP OF 39mm PARALLELS +", id:"TOP OF 39mm PARALLELS +"},
      {title:"TOP OF 24mm PARALLELS +", id:"TOP OF 24mm PARALLELS +"},
      {title:"TOP OF 20mm PARALLELS +", id:"TOP OF 20mm PARALLELS +"},
      {title:"FACE OF TRIAG RAIL +", id:"FACE OF TRIAG RAIL +"},
      {title:"TOP OF STOCK, ADJUST FOR MIN. CLEAN-UP", id:"TOP OF STOCK, ADJUST FOR MIN. CLEAN-UP"},
      {title:"BOTTOM OF STOCK", id:"BOTTOM OF STOCK"},
      {title:"MIDDLE OF STOCK", id:"MIDDLE OF STOCK"},
      {title:"FACE OF PALLET", id:"FACE OF PALLET"},
      {title:"FACE OF FIXTURE", id:"FACE OF FIXTURE"},
      {title:"AUTO-SET", id:"AUTO-SET"},
      {title:"AUTO-SET W/PROBE", id:"AUTO-SET W/PROBE"},
    ]
  }
...
function onOpen() {
  ...
  var templatePath = FileSystem.getCombinedPath(getConfigurationFolder(), "!Sauer_SSExcel_SetupSheet.xlsx");
  ...
  programInfo["program.xylocation"] = properties.xyLocation;
  programInfo["program.zlocation"] = properties.zLocation;
  programInfo["program.xLocationDim"] = properties.xLocationDim;
  programInfo["program.yLocationDim"] = properties.yLocationDim;
  programInfo["program.notes"] = properties.jobNotes;
